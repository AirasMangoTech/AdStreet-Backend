...
banner_route.get("/getDragonsOfPakistanBanners", [verifyToken], banner.getDragonsOfPakistanBanners);
banner_route.get("/getAdvisionBanners", [verifyToken], banner.getAdvisionBanners);
